                ...
                <div className="min-h-screen flex flex-col">
                  ...
                  <div className="flex-1">
                    ...
                    <Routes>
                      ...
                      <Route path="/services/category/:categoryId/:subCategoryId" element={<ServiceCategory />} />
                      ...
                      <Route path="/shopping/category/:categoryId/:subCategoryId" element={<ShoppingCategory />} />
                      <Route path="/shopping/product/:id" element={<DigitalProduct />} />
