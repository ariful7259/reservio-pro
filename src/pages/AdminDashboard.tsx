...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen flex" id="admin-dashboard-container" style={{ backgroundColor: adminTheme.colors.background }}>
      {/* Sidebar */}
      <div className="w-64 bg-white shadow-lg overflow-y-auto flex-shrink-0">
        ...
        <div className="p-4">
          <div className="space-y-1">
            ...
            <Button 
              variant="ghost" 
              className="w-full justify-start text-blue-500 mt-2" 
              onClick={() => navigate('/')}
            >
              <Home size={18} />
