  ...
  return <div className="container px-4 pt-20 pb-20">
      ...
      <div className="flex gap-2 mb-6">
        <div className="flex-1 relative">
          ...
          <Input type="text" placeholder="সেবা খুঁজুন..." className="pl-10" value={searchTerm} onChange={e => setSearchTerm(e.target.value)} />
        </div>
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold">
            {selectedCategory === 'all' ? 'সকল সার্ভিস' : serviceCategories.find(c => c.id === selectedCategory)?.name || 'সার্ভিস'}
          </h2>
              ...
              <CardContent className="p-0">
                <div className="relative aspect-video">
                  ...
                  <div className="absolute top-2 right-2 flex flex-col gap-2">
                    ...
                    <Button variant="outline" size="icon" className="bg-white h-8 w-8 rounded-full" onClick={e => handleShare(e, service.id)}>
                ...
                <div className="p-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    {service.isVerified && <Badge variant="secondary" className="flex items-center gap-1 text-xs">
                  ...
                  <div className="flex flex-wrap gap-1 mb-3">
                    {service.bookingTypes.map((type, index) => <Badge key={index} variant="outline" className="text-xs">
                        {type}
                      </Badge>)}
                  </div>
