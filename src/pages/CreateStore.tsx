        ...
        <div className="w-full mb-4">
          <TabsList className="flex w-full h-auto p-2 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border overflow-x-auto scrollbar-hide gap-2">
            <div className="flex gap-2 min-w-max">
              <TabsTrigger 
                value="easy-setup" 
                className="flex flex-col items-center gap-2 p-4 text-xs font-medium data-[state=active]:bg-white data-[state=active]:shadow-lg data-[state=active]:border transition-all duration-300 rounded-lg min-w-[120px] whitespace-nowrap"
              >
                <div className="p-3 rounded-full bg-gradient-to-r from-green-400 to-blue-500 text-white shadow-md">
                  <Zap className="h-5 w-5" />
                </div>
                <span className="font-bold text-sm text-center">সহজ সেটআপ</span>
              ...
              >
                ...
                <span className="font-bold text-sm text-center">ফিচারস</span>
                <span className="text-xs text-muted-foreground text-center">সব ফিচার</span>
              </TabsTrigger>
              <TabsTrigger 
                value="design" 
