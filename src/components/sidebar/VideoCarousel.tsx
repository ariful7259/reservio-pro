              ...
              <div className="rounded-lg overflow-hidden border shadow-card">
                <div className="aspect-video bg-black flex items-center justify-center relative">
                  ...
                  <div className="absolute bottom-2 right-2 flex pointer-events-none">
                    <Button variant="default" size="lg" onClick={() => handleBook(ad)} aria-label={`${ad.title} বুক করুন`} className="pointer-events-auto bg-primary text-white font-bold px-5 py-2 rounded-full shadow-lg hover:bg-primary/90 flex items-center gap-1 transition-smooth md:text-base md:px-5 md:py-2 px-4 py-1.5 active:scale-95 text-xs">
                ...
                <div className="p-3">
                  ...
                  <Button variant="default" size="lg" className="w-full mt-1 block md:hidden bg-primary text-white font-bold py-3 rounded-full" onClick={() => handleBook(ad)}>
