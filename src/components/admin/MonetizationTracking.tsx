          ...
          <Tabs defaultValue="dashboard">
            ...
            <TabsContent value="features" className="space-y-4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <Card>
                  ...
                  <CardContent className="p-4">
                    <div className="space-y-4">
                      ...
                      <div className="relative pt-1">
                        <div className="flex justify-between text-sm mb-1">
                          <span>বুকিং/অর্ডার স্টার্ট</span>
                          <span className="font-medium">18,734</span>
                        </div>
                        <div className="overflow-hidden h-4 mb-2 text-xs flex rounded bg-blue-50">
                    ...
                    <div className="mt-4 pt-4 border-t">
                      <div className="grid grid-cols-3 gap-2 text-center text-sm">
                        <div>
                          <div className="font-medium">11.5%</div>
                          <div className="text-xs text-muted-foreground">কনভার্সন রেট</div>
                        </div>
                        <div>
                          <div className="font-medium">৳ 1,850</div>
                          <div className="text-xs text-muted-foreground">গড় অর্ডার ভ্যালু</div>
                        </div>
                        <div>
                          <div className="font-medium">৳ 225</div>
                          <div className="text-xs text-muted-foreground">ভিজিটর মূল্য</div>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-base">ক্রস-ফিচার পারফরম্যান্স</CardTitle>
                  </CardHeader>
                  <CardContent className="p-4">
                    <div className="space-y-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex-1">
                          <div className="flex justify-between mb-1">
                            <span className="font-medium">রেন্টাল</span>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="w-full bg-gray-200 rounded-full h-2.5">
                            <div className="bg-amber-600 h-2.5 rounded-full" style={{ width: "82%" }}></div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex-1">
                          <div className="flex justify-between mb-1">
                            <span className="font-medium">ডিজিটাল কন্টেন্ট</span>
                    ...
                    <div className="mt-6 pt-4 border-t">
                      <h4 className="font-medium mb-3">ফিচার ক্রস-সেলিং</h4>
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span>রেন্টাল → সার্ভিস</span>
                          <span className="font-medium">35% কনভার্সন</span>
                        </div>
                        <div className="flex justify-between">
                          <span>সার্ভিস → মার্কেটপ্লেস</span>
                          <span className="font-medium">28% কনভার্সন</span>
                        </div>
                        <div className="flex justify-between">
                          <span>মার্কেটপ্লেস → ডিজিটাল</span>
                          <span className="font-medium">15% কনভার্সন</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
            ...
            <TabsContent value="rules" className="space-y-4">
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="border-b">
                      <th className="text-left py-3 px-4 text-sm font-medium">স্ট্যাটাস</th>
                      ...
                      <th className="text-left py-3 px-4 text-sm font-medium">পারফরম্যান্স</th>
                      <th className="text-right py-3 px-4 text-sm font-medium">রেভিনিউ</th>
                      <th className="text-right py-3 px-4 text-sm font-medium">অ্যাকশন</th>
                    </tr>
                  </thead>
                  <tbody>
                    {monetizationRules.map((rule, index) => (
                      <tr key={index} className="border-b last:border-b-0 hover:bg-gray-50">
                        ...
                        <td className="py-3 px-4">
                          <Badge variant={
                            rule.type === 'percentage' ? 'info' :
                            rule.type === 'fee' ? 'success' :
                            rule.type === 'subscription' ? 'premium' : 'secondary'
                        ...
                        <td className="py-3 px-4">
                          <Badge variant={
                            ...
                            rule.performance === 'medium' ? 'info' : 'warning'
                          } className="font-normal">
                        ...
                        <td className="py-3 px-4 text-right">
                          <span className="font-medium">৳ {(rule.revenueGenerated / 1000).toFixed(0)}K</span>
                        </td>
                        <td className="py-3 px-4 text-right">
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-base">রুল পারফরম্যান্স সারসংক্ষেপ</CardTitle>
                </CardHeader>
                <CardContent className="p-4">
                  <div className="flex flex-col lg:flex-row gap-4">
                    <div className="flex-1">
                      <div className="space-y-4">
                        <div className="flex justify-between items-center">
                          <div>
                            <div className="text-sm text-muted-foreground">সক্রিয় রুল</div>
                            <div className="text-2xl font-bold">7</div>
                          </div>
                          <div>
                            <div className="text-sm text-muted-foreground">মোট মাসিক রেভিনিউ</div>
                            <div className="text-2xl font-bold">৳ 5,23,000</div>
                          </div>
                          <div>
                            <div className="text-sm text-muted-foreground">গড় কনভার্সন</div>
                            <div className="text-2xl font-bold">3.8%</div>
                          </div>
                        </div>
                        
                        <div className="space-y-2">
                          <div className="text-sm font-medium">রেভিনিউ বাই রুল টাইপ</div>
                          <div className="space-y-2">
                            <div className="flex justify-between items-center">
                              <div className="flex items-center gap-2">
                                <div className="w-3 h-3 rounded-full bg-blue-500"></div>
                                <span className="text-sm">পারসেন্টেজ কমিশন</span>
                              </div>
                              <div className="text-sm font-medium">৳ 1,85,000</div>
                            </div>
                            <div className="flex justify-between items-center">
                              <div className="flex items-center gap-2">
                                <div className="w-3 h-3 rounded-full bg-green-500"></div>
                                <span className="text-sm">ফিক্সড ফি</span>
                              </div>
                              <div className="text-sm font-medium">৳ 1,90,000</div>
                            </div>
                            <div className="flex justify-between items-center">
                              <div className="flex items-center gap-2">
                              ...
                              <div className="text-sm font-medium">৳ 1,03,000</div>
                            </div>
                            <div className="flex justify-between items-center">
                              <div className="flex items-center gap-2">
                    ...
                    <div className="lg:w-96">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          <span className="text-muted-foreground">বেস্ট পারফর্মিং রুল</span>
                          <span className="font-medium">প্রিমিয়াম লিস্টিং</span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-muted-foreground">বেস্ট কনভার্সন রেট</span>
                          <span className="font-medium">সার্ভিস কমিশন (5.2%)</span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-muted-foreground">সবচেয়ে প্রফিটেবল ফিচার</span>
                          <span className="font-medium">মার্কেটপ্লেস</span>
                        </div>
                      </div>
                    </div>
            ...
            <TabsContent value="reports" className="space-y-4">
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-base">রেভিনিউ ট্রেন্ড রিপোর্ট (জুন ২০২৫)</CardTitle>
                </CardHeader>
                <CardContent className="p-4">
                  <div className="h-80">
                    <BarChart>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mt-6">
                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-xs text-green-600">+12.5% MoM</div>
                    </div>
                    
                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                      <div className="text-sm text-muted-foreground">মার্কেটপ্লেস</div>
                      <div className="text-xl font-bold">৳ 4.5L</div>
                      <div className="text-xs text-green-600">+6.8% MoM</div>
                    </div>
                    
                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                      <div className="text-sm text-muted-foreground">সার্ভিস</div>
                      <div className="text-xl font-bold">৳ 3.2L</div>
                      <div className="text-xs text-green-600">+15.2% MoM</div>
                    </div>
                    
                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                      <div className="text-sm text-muted-foreground">রেন্টাল</div>
                      <div className="text-xl font-bold">৳ 2.8L</div>
                      <div className="text-xs text-green-600">+8.7% MoM</div>
                    </div>
                    
                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                      <div className="text-sm text-muted-foreground">ডিজিটাল</div>
                      <div className="text-xl font-bold">৳ 1.5L</div>
                      <div className="text-xs text-green-600">+20.3% MoM</div>
                    </div>
                    
                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                      <div className="text-sm text-muted-foreground">অন্যান্য</div>
                      <div className="text-xl font-bold">৳ 2.7L</div>
                      <div className="text-xs text-green-600">+9.4% MoM</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-base">প্রবৃদ্ধি ফোরকাস্ট (জুলাই - ডিসেম্বর ২০২৫)</CardTitle>
                  </CardHeader>
                  <CardContent className="p-4">
                    <div className="h-72">
                      <AreaChart>
                    ...
                    <div className="flex flex-wrap gap-3 mt-4 justify-center">
                      <div className="flex items-center gap-1">
                        <div className="w-3 h-3 rounded-full bg-blue-500"></div>
                        <span className="text-sm">অ্যাকচুয়াল</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <div className="w-3 h-3 rounded-full bg-blue-300"></div>
                        <span className="text-sm">ফোরকাস্ট</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-base">টপ মোনিটাইজেশন মেট্রিক্স</CardTitle>
                  </CardHeader>
                  <CardContent className="p-4">
                    <div className="grid grid-cols-1 gap-4">
                      <div className="flex justify-between items-center">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="font-medium">গড় অর্ডার ভ্যালু</div>
                            <div className="text-sm text-muted-foreground">গত ৩০ দিন</div>
                          </div>
                        </div>
                        <div className="text-right">
                          <div className="text-xl font-bold">৳ 1,850</div>
                          <div className="text-sm text-red-600">-2.3% MoM</div>
                        </div>
                      </div>
                      ...
                      <div className="flex justify-between items-center">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="font-medium">কনভার্সন রেট</div>
                            <div className="text-sm text-muted-foreground">গত ৩০ দিন</div>
                          </div>
                        </div>
                        <div className="text-right">
                          <div className="text-xl font-bold">4.8%</div>
                          <div className="text-sm text-green-600">+0.5% MoM</div>
                        </div>
                      </div>
                      ...
                      <div className="flex justify-between items-center">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="font-medium">মাসিক অ্যাকটিভ ইউজার</div>
                            <div className="text-sm text-muted-foreground">গত ৩০ দিন</div>
                          </div>
                        </div>
                        <div className="text-right">
                          <div className="text-xl font-bold">52,450</div>
                      ...
                      <div className="flex justify-between items-center">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="font-medium">ইউজার দিন প্রতি আয়</div>
                            <div className="text-sm text-muted-foreground">গত ৩০ দিন</div>
                          </div>
                        </div>
                        <div className="text-right">
                          <div className="text-xl font-bold">৳ 8.5</div>
                          <div className="text-sm text-green-600">+14.5% MoM</div>
                        </div>
                      </div>
                    </div>
                  </CardContent>
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-base">মোনিটাইজেশন ইন্টেলিজেন্স রিপোর্ট</CardTitle>
                  <CardDescription>
                    আপনার মোনিটাইজেশন পারফরম্যান্স উন্নত করার জন্য সুপারিশ এবং উপায়
                  </CardDescription>
                </CardHeader>
                <CardContent className="p-4">
                  <div className="space-y-4">
                    <div className="flex items-start gap-4 p-4 rounded-lg bg-blue-50">
                      ...
                      <div>
                        <h3 className="font-medium mb-1">পাম্প আপ ইউর সার্ভিস কমিশন</h3>
                        <p className="text-sm text-muted-foreground">
                          সার্ভিস সেক্টরে কনভার্সন রেট 5.2%, যা অন্যান্য সেক্টরের তুলনায় বেশি। 
                          কমিশন রেট অপ্টিমাইজ করে (বর্তমান 10% থেকে বাড়িয়ে 12%) 
                          আরও ৳ 35,000 মাসিক রাজস্ব পেতে পারেন।
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-4 rounded-lg bg-purple-50">
                      ...
                      <div>
                        <h3 className="font-medium mb-1">ডিজিটাল কন্টেন্ট বানডেল অফার</h3>
                        <p className="text-sm text-muted-foreground">
                          ডিজিটাল কন্টেন্ট বিভাগে সবচেয়ে দ্রুত প্রবৃদ্ধি (20.3%) হচ্ছে। 
                          সাবস্ক্রিপশন মডেল যোগ করে এবং কন্টেন্ট বানডেল অফার দিয়ে 
                          এই প্রবৃদ্ধি আরও 15% বাড়ানো সম্ভব।
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-4 rounded-lg bg-amber-50">
                      ...
                      <div>
                        <h3 className="font-medium mb-1">মার্কেটপ্লেস টিয়ার্ড লিস্টিং ফি</h3>
                        <p className="text-sm text-muted-foreground">
                          প্রিমিয়াম লিস্টিং ফি (৳500) সবচেয়ে বেশি রাজস্ব উৎপন্ন করছে। 
                          টিয়ার্ড লিস্টিং ফি মডেল (৳300-৳1,500) যোগ করে এবং সাইট এ প্রিমিয়াম স্পট 
                          বিক্রি করে রাজস্ব 25% বাড়ানো সম্ভব।
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-4 rounded-lg bg-green-50">
                      ...
                      <div>
                        <h3 className="font-medium mb-1">প্রিমিয়াম রেন্টাল সার্ভিস টিয়ার</h3>
                        <p className="text-sm text-muted-foreground">
                          রেন্টাল সেক্টরে ফিচার্ড লিস্টিং ভাল পারফর্ম করছে কিন্তু সার্ভিস টিয়ার বিকল্প 
                          নেই। স্ট্যান্ডার্ড, প্রিমিয়াম, এবং এক্সক্লুসিভ টিয়ার যোগ করে রাজস্ব 
                          উল্লেখযোগ্যভাবে বাড়ানো সম্ভব।
                        </p>
                      </div>
                    </div>
                  </div>
