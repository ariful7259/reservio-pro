      ...
      <>
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogContent className="max-w-xs w-[95vw] p-0 rounded-2xl overflow-hidden !gap-0">
            <DialogHeader className="flex flex-row items-center justify-between px-4 pt-4 pb-2 bg-white">
              <DialogTitle className="text-pink-600 text-base font-bold">Wish2Earn</DialogTitle>
              <DialogClose asChild>
                <button
                  type="button"
            ...
            <div className="px-3 pt-1 pb-4 bg-white overflow-y-auto" style={{ maxHeight: '70vh' }}>
              <Wish2EarnModule />
            </div>
          </DialogContent>
        </Dialog>
