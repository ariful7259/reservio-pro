...
const stats = [
  { label: "মোট আয়", value: "৳70,650", color: "text-purple-500", bg: "bg-purple-50" },
  { label: "সক্রিয় ইচ্ছে", value: "2", color: "text-blue-500", bg: "bg-blue-50" },
  { label: "আবেদনের মাঝে", value: "0", color: "text-green-500", bg: "bg-green-50" },
    ...
    <div className="w-full max-w-5xl mx-auto bg-gradient-to-b from-purple-50/50 via-white to-blue-50/10 rounded-2xl shadow-xl pb-16">
      ...
      <div className="px-4 mb-1">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          {wishlists.map((w) => (
            <div key={w.id} className="flex-1 bg-white shadow rounded-xl relative overflow-hidden px-4 py-4 min-w-[250px]">
      ...
      <div className="px-4 mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {quickActions.map((a, idx) => (
            <div key={idx} className={`rounded-xl bg-gradient-to-br ${idx === 0
                ? "from-violet-100 to-purple-200"
                : idx === 1
                  ? "from-blue-100 to-blue-300"
                  : "from-green-100 to-green-200"
              } p-5 shadow-md flex flex-col items-center`}>
              {a.icon}
