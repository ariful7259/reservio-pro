      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>গত ৬ মাসের আয়ের চার্ট</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-[300px] flex items-center justify-center border-2 border-dashed rounded-lg">
              <div className="text-center">
                <LineChart className="h-12 w-12 text-muted-foreground mx-auto mb-2" />
                <p className="text-muted-foreground">আয়ের ট্রেন্ড চার্ট</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle>বিক্রয় বিভাগ</CardTitle>
            <CardDescription>প্রোডাক্ট ক্যাটাগরি অনুযায়ী বিক্রয়</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-[300px] flex items-center justify-center border-2 border-dashed rounded-lg">
              <div className="text-center">
                <PieChart className="h-12 w-12 text-muted-foreground mx-auto mb-2" />
                <p className="text-muted-foreground">ক্যাটাগরি অনুযায়ী বিক্রয়</p>
              </div>
            </div>
          </CardContent>
        </Card>
